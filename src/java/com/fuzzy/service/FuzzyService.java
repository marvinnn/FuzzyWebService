...
public class FuzzyService {
    ...
    public List<String> doSearch(@WebParam(name = "querry") String querry){
        ...
        int i = 0;
        TfIdfCalculatorWithFuzzy calculator = new TfIdfCalculatorWithFuzzy();
        while (i < documents.size()) {
            int j = 0;
            double tfIdfValue = 0;
            double titleValue = 0;
            while (j < query.size()) {
                tfIdfValue += calculator.tfIdf(documents.get(i), documents, query.get(j), query);
                titleValue += calculator.tfIdf(titles.get(i), titles, query.get(j), query);
                j++;//increment
            }
        ...
        ArrayList<TfIdfWithArticleIndex> arrayToSort = new ArrayList<TfIdfWithArticleIndex>();
                i = 0;
                while (i < tfIdf.size()) {
                    TfIdfWithArticleIndex tempOfTfIdf = new TfIdfWithArticleIndex(i, tfIdf.get(i), titleCollection.get(i));
                ...
                while (i < tfIdf.size()) {
                    if (arrayToSort.get(i).getArticleTfIdf().equals("0.0")) {
                        ...
                        searchResult.add(arrayToSort.get(i).getArticleTitle());
                    }
                    i++;
                }

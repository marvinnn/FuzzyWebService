...
public class FuzzyRules implements Rules{
    ...
    public List<Double> calculate(List<Double> tf, List<Double> idf, List<Double> n){
        ...
        result.add(Math.min(tf.get(0), idf.get(0)));//Low
        result.add(Math.min(tf.get(0), idf.get(1)));//Low
        result.add(Math.min(tf.get(0), idf.get(2)));//Low
        result.add(Math.min(tf.get(0), idf.get(3)));//Medium
        result.add(Math.min(tf.get(0), idf.get(4)));//Medium
        
        result.add(Math.min(tf.get(1), idf.get(0)));//Low
        result.add(Math.min(tf.get(1), idf.get(1)));//Low
        result.add(Math.min(tf.get(1), idf.get(2)));//Low
        result.add(Math.min(tf.get(1), idf.get(3)));//Medium
        result.add(Math.min(tf.get(1), idf.get(4)));//Mediun
        
        result.add(Math.min(tf.get(2), idf.get(0)));//Low
        result.add(Math.min(tf.get(2), idf.get(1)));//Medium
        result.add(Math.min(tf.get(2), idf.get(2)));//Medium
        result.add(Math.min(tf.get(2), idf.get(3)));//Medium
        result.add(Math.min(tf.get(2), idf.get(4)));//Medium
        
        result.add(Math.min(tf.get(3), idf.get(0)));//Medium
        result.add(Math.min(tf.get(3), idf.get(1)));//Medium
        result.add(Math.min(tf.get(3), idf.get(2)));//Medium
        result.add(Math.min(tf.get(3), idf.get(3)));//High
        result.add(Math.min(tf.get(3), idf.get(4)));//High
        
        result.add(Math.min(tf.get(4), idf.get(0)));//Medium
        result.add(Math.min(tf.get(4), idf.get(1)));//Medium
        result.add(Math.min(tf.get(4), idf.get(2)));//Medium
        result.add(Math.min(tf.get(4), idf.get(3)));//High
        result.add(Math.min(tf.get(4), idf.get(4)));//High
    ...
    public List<Double> zValue(List<Double> ruleResult){
        ...
        result.add(0.4 - 0.4 * ruleResult.get(10));
        ...
        result.add(0.6 + 0.4 * ruleResult.get(18));

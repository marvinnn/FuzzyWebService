...
public class ProposedFuzzyCalculator implements Calculator{
    ...
    public List<Double> tfDocFuzzification(double tf){
        TfMembershipFunction mf = new TfMembershipFunction();
    ...
    public List<Double> nQueFuzzification(double n){
        NMembershipFunction mf = new NMembershipFunction();
        List<Double> fuzzyClass = new ArrayList<>();
